...
def predict():
    try:
        ...
        probability = model.predict_proba(data_scaled)[0][1] * 100 # Probability of having diabetes
        ...
        return jsonify({"message": f"Prediction: {prediction_text}", "probability": f"{round(probability, 2)}%"})
